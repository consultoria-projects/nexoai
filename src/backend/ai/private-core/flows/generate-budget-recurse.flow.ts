...
import { constructionArchitectAgent } from '@/backend/ai/private-core/agents/construction-architect.agent';
...
export const generateBudgetRecurseFlow = ai.defineFlow(
    ...
    async (input) => {
        ...
        for (const chapter of architectResult.chapters) {
            ...
            const { constructionAnalystAgent } = await import('@/backend/ai/private-core/agents/construction-analyst.agent');
