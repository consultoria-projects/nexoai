...
// import { budgetSearchAgent } from '@/backend/ai/private-core/agents/budget-search.agent';
// import { triageAgent } from '@/backend/ai/private-core/agents/triage.agent';
// import { resolveItemFlow } from '@/backend/ai/private-core/flows/resolve-item.flow';
...
async function runDebug() {
    ...
    const { triageAgent } = await import('@/backend/ai/private-core/agents/triage.agent');
    const { budgetSearchAgent } = await import('@/backend/ai/private-core/agents/budget-search.agent');
    const { priceBookRetrieverTool } = await import('@/backend/ai/private-core/tools/price-book-retriever.tool');
