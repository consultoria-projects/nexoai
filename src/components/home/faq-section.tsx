...
const faqs = [
    {
        ...
        answer: "El tiempo varía según la complejidad, pero una reforma integral estándar suele oscilar entre 3 y 5 meses. En Basis, garantizamos plazos cerrados por contrato gracias a nuestra planificación previa con tecnología 3D, evitando los retrasos habituales del sector."
    },
    {
